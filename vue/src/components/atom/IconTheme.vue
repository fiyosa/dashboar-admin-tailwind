...
<template>
  <button
    v-show="_themeStore.get === 'light'"
    @click="_themeStore.set('dark')"
    :class="
      _themeStore.get === 'light'
        ? 'border border-gray-200 text-gray-700 hover:bg-gray-200'
        : 'border border-gray-200 text-gray-200 hover:bg-gray-700'
    "
  ...
  <button
    v-show="_themeStore.get === 'dark'"
    @click="_themeStore.set('light')"
    :class="
      _themeStore.get === 'light'
        ? 'border border-gray-200 text-gray-700 hover:bg-gray-200'
